...
class MyMissionViewModel @Inject constructor(private val missionRepository: MissionRepository) :
    ...
    val progressMainMissionList: LiveData<List<ResponseMainMissionCard.ResultMissionCard>> =
        _progressMainMissionList
    ...
    fun setGroupExistState(stateValue: Boolean) {
        groupExistState.value = stateValue
    }
}