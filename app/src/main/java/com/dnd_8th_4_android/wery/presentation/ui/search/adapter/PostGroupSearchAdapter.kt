...
import com.dnd_8th_4_android.wery.databinding.ItemPostGroupSearchBinding
...
class PostGroupSearchAdapter :
    ListAdapter<ResponsePostSearchData.Data.Content, PostGroupSearchAdapter.ViewHolder>(diffUtil) {
    private lateinit var binding: ItemPostGroupSearchBinding
    var wordText = ""

    inner class ViewHolder(private val binding: ItemPostGroupSearchBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        binding =
            ItemPostGroupSearchBinding.inflate(LayoutInflater.from(parent.context), parent, false)
